...
Ensures py-review-skill's runtime surface remains cross-agent compatible.
Patterns are scoped to what would break non-Hermes agents (the primary
alternative runtimes: Claude Code, Codex CLI, Gemini CLI, OpenCode, Cursor).
